...
//So luong don hang
$sql_count_orders = "SELECT COUNT(*) AS totalOrders FROM donhang";
$stmt_count_orders = $conn->prepare($sql_count_orders);
$stmt_count_orders->execute();
$row_count_orders = $stmt_count_orders->fetch(PDO::FETCH_ASSOC);
$totalOrders = $row_count_orders['totalOrders'];
?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index2_admin.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
